...
<body>
  ...
  <main><div class="toolbar"><select id="budgetFilter"><option value="all">Tous les budgets</option></select><select id="statusFilter"><option value="all">Toutes les dépenses</option><option value="planned">Prévues</option><option value="realised">Réalisées</option></select></div><div class="expenses" id="expenses"></div></main>
